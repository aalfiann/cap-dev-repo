                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-body printableArea">
                                <!-- Sheet 1 start -->
                                <h3><b>'.strtoupper(Core::lang('invoice')).'</b> <span class="pull-right">#'.$datainvoice->result[0]->InvoiceID.' <b class="text-'.(($datainvoice->result[0]->StatusID == 34)'success':'danger').'">['.strtoupper($datainvoice->result[0]->Status).']</b></span></h3>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="pull-left">
                                            <address>
