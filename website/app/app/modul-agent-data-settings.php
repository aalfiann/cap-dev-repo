...
<head>
    ...
    <title><?php echo Core::lang('data').' '.Core::lang('agent_setting')?> - <?php echo Core::getInstance()->title?></title>
</head>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><?php echo Core::lang('data').' '.Core::lang('agent_setting')?></h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo Core::lang('data').' '.Core::lang('agent_setting')?></li>
                    </ol>
                </div>
                <div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3 class="text-themecolor m-b-0 m-t-0"><?php echo Core::lang('data').' '.Core::lang('agent_setting')?></h3><hr>
                                <h6 class="card-subtitle"><?php echo Core::lang('agent_setting_description')?></h6>
                                <div class="table-responsive m-t-40">
                                    <a href="#" data-toggle="modal" data-target=".addnew" class="btn btn-inverse"><i class="mdi mdi-key-plus"></i> <?php echo Core::lang('add').' '.Core::lang('agent_setting')?></a>
                                    <!-- terms modal content -->
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title text-themecolor" id="myLargeModalLabel"><i class="mdi mdi-key-plus"></i> <?php echo Core::lang('add').' '.Core::lang('agent_setting')?></h4>
                                                ...
                                                <form class="form-horizontal form-material" id="addnewdata" action="#">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12"><?php echo Core::lang('agent_setting_key')?></label>
                                                             <div class="col-md-12">
                                                                <input id="key" type="text" class="form-control form-control-line" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-12"><?php echo Core::lang('agent_setting_value')?></label>
                                                             <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12"><?php echo Core::lang('agent_setting_desc')?></label>
                                                             <div class="col-md-12">
                                    ...
                                    <table id="datamain" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo Core::lang('agent_setting_key')?></th>
                                                <th><?php echo Core::lang('agent_setting_value')?></th>
                                                ...
                                                <th><?php echo Core::lang('agent_setting_desc')?></th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                            <tr>
        ...
        function loadData(idtable,page="1",itemperpage="10",search=""){
            $(function() {
                ...
                var table = $(idtable).DataTable({
                    ajax: {
                        type: "GET",
                        url: "<?php echo Core::getInstance()->api.'/cargoagent/config/index/'.$datalogin['username'].'/'.$datalogin['token'].'/"+page+"/"+itemperpage+"/?query="+encodeURIComponent(search)+"'?>",
                        cache: false,
                    ...
                    columns: [
                        ...
                        { data: "Updated_by" },
                        { "render": function(data,type,row,meta) { /* render event defines the markup of the cell text */ 
                                var a = '<a href="#" data-toggle="modal" data-target=".'+row.KeyID+'"><i class="mdi mdi-pencil-box-outline"></i> <?php echo Core::lang('edit')?></a>'; /* row object contains the row data */
                                a += '<!-- terms modal content -->\
                                    <div class="modal fade '+row.KeyID+'" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">\
                                        <div class="modal-dialog modal-lg">\
                                            <div class="modal-content">\
                                                <div class="modal-header">\
                                                    <h4 class="modal-title text-themecolor" id="myLargeModalLabel"><i class="mdi mdi-key-plus"></i> <?php echo Core::lang('update').' '.Core::lang('agent_setting')?></h4>\
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>\
                                                </div>\
                                                <form class="form-horizontal form-material" id="data'+row.KeyID+'" action="<?php echo $_SERVER['PHP_SELF']?>">\
                                                    <div class="modal-body">\
                                                        <div class="form-group">\
                                                        ...
                                                        <div class="form-group">\
                                                            <label class="col-md-12"><?php echo Core::lang('agent_setting_key')?></label>\
                                                             <div class="col-md-12">\
                                                                <input id="'+row.KeyID+'" type="text" class="form-control form-control-line" value="'+row.KeyID+'" readonly>\
                                                            </div>\
                                                        </div>\
                                                        <div class="form-group">\
                                                            <label class="col-md-12"><?php echo Core::lang('agent_setting_value')?></label>\
                                                             <div class="col-md-12">\
                                                                <textarea id="value'+row.KeyID+'" type="text" rows="3" style="resize: vertical;" class="form-control form-control-line" maxlength="10000" required>'+row.Config+'</textarea>\
                                                            </div>\
                                                        </div>\
                                                        <div class="form-group">\
                                                            <label class="col-md-12"><?php echo Core::lang('agent_setting_desc')?></label>\
                                                             <div class="col-md-12">\
                                                                <textarea id="description'+row.KeyID+'" type="text" rows="3" style="resize: vertical;" class="form-control form-control-line" maxlength="250" required>'+row.Description+'</textarea>\
                                                            </div>\
                                                        </div>\
                                                    </div>\
                                                    <div class="modal-footer">\
                                                        ...
                                                        <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">\
                                                            <div class="btn-group mr-2" role="group" aria-label="First group">\
                                                                <button id="deletebtn'+row.KeyID+'" type="submit" onclick="deletedata(\''+row.KeyID+'\');return false;" class="btn btn-danger"><?php echo Core::lang('delete')?></button>\
                                                            </div>\
                                                            <div class="btn-group mr-2" role="group" aria-label="Second group">\
                                                                <button type="button" class="btn btn-default waves-effect text-left mr-2" data-dismiss="modal"><?php echo Core::lang('cancel')?></button>\
                                                                <button id="updatebtn'+row.KeyID+'" type="submit" onclick="updatedata(\''+row.KeyID+'\');return false;" class="btn btn-success"><?php echo Core::lang('update')?></button>\
                                                            </div>\
                                                        </div>\
                                                        </div>\
                                                    </div>\
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == "success"){
                            div.innerHTML = messageHtml("success","<?php echo Core::lang('core_process_add').' '.Core::lang('agent_setting').' '.Core::lang('status_success')?>");
                            /* clear from */
                            $("#addnewdata")
                            .find("input,textarea")
                            .val("")
                            ...
                            .prop("checked", "")
                            .end();
                            console.log("<?php echo Core::lang('core_process_add').' '.Core::lang('agent_setting').' '.Core::lang('status_success')?>");
                            $('#datamain').DataTable().ajax.reload(); /* reload data table */
                            that.on("submit", sendnewdata); /* add handler back after ajax */
                        } else {
                            div.innerHTML = messageHtml("danger","<?php echo Core::lang('core_process_add').' '.Core::lang('agent_setting').' '.Core::lang('status_failed')?>",data.message);
                            that.on("submit", sendnewdata); /* add handler back after ajax */
                        }
                    },
                    complete: function(){
            ...
            $(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        div.innerHTML = "";
                        if (data.status == "success"){
                            div.innerHTML = messageHtml("success","<?php echo Core::lang('core_process_update').' '.Core::lang('agent_setting').' '.Core::lang('status_success')?>");
                            console.log("<?php echo Core::lang('core_process_update').' '.Core::lang('agent_setting').' '.Core::lang('status_success')?>");
                            $('#datamain').DataTable().ajax.reload(); /* reload data table */
                            $('.'+dataid).modal('hide');
                        } else {
                            div.innerHTML = messageHtml("danger","<?php echo Core::lang('core_process_update').' '.Core::lang('agent_setting').' '.Core::lang('status_failed')?>",data.message);
                            $('.'+dataid).modal('hide');
                        }
                    },
                    complete: function(){
        ...
        function deletedata(dataid){
            $(function() {
                ...
                swal({   
                    ...
                    text: "<?php echo Core::lang('agent_setting_delete_warning')?>",   
                    type: "warning",   
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            div.innerHTML = "";
                            if (data.status == "success"){
                                div.innerHTML = messageHtml("success","<?php echo Core::lang('core_process_delete').' '.Core::lang('agent_setting').' '.Core::lang('status_success')?>");
                                console.log("<?php echo Core::lang('core_process_delete').' '.Core::lang('agent_setting').' '.Core::lang('status_success')?>");
                                swal("<?php echo Core::lang('core_delete_success')?>", data.message, "success");
                                $('#datamain').DataTable().ajax.reload(); /* reload data table */
                                $('.'+dataid).modal('hide');
                            } else {
                                div.innerHTML = messageHtml("danger","<?php echo Core::lang('core_process_delete').' '.Core::lang('agent_setting').' '.Core::lang('status_failed')?>",data.message);
