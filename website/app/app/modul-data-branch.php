            ...
            $(function() {
                ...
                var table = $(idtable).DataTable({
                    ...
                    columns: [
                        ...
                        { data: "Updated_by" },
                        { "render": function(data,type,row,meta) { /* render event defines the markup of the cell text */ 
                                var $select = $('<select id="status'+row.BranchID+'" type="text" style="max-height:200px; overflow-y:scroll; overflow-x:hidden;" class="form-control form-control-line"><?php if (!empty($datastatus)) {
