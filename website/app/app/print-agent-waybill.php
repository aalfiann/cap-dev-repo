...
$refpage = (empty($_GET['ref'])?'modul-agent-transaction.php':$_GET['ref'].$refdate);
$waybill = (empty($_GET['no'])?'0000000000000':$_GET['no']);
$datalogin = Core::checkSessions();
// Get data waybill
$urlwaybill = Core::getInstance()->api.'/cargoagent/transaction/data/waybill/'.$datalogin['username'].'/'.$datalogin['token'].'/'.$waybill;
                    ...
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <h3><b class="text-primary">'.(empty($datawaybill->result[0]->Company->Logo)?$datawaybill->result[0]->Company->Name:'<img src="'.$datawaybill->result[0]->Company->Logo.'" width="300" height="40" alt="'.$datawaybill->result[0]->Company->Name.'">').'</b></h3>
                                        <span style="font-size: 9px !important;">'.$datawaybill->result[0]->Company->Address.'
                                        <br>
                                        <i class="mdi mdi-phone-classic"></i> : '.$datawaybill->result[0]->Company->Phone.(empty($datawaybill->result[0]->Company->Fax)?'':' | <i class="mdi mdi-fax"></i> : '.$datawaybill->result[0]->Company->Fax).(empty($datawaybill->result[0]->Company->Email)?'':' | <i class="mdi mdi-email-outline"></i> : '.$datawaybill->result[0]->Company->Email).'</span>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        ...
                                        <table style="width:300px">
                                            ...
                                            <tr>
                                                <td align="left"><span style="font-size: 9px !important;">'.strtoupper($datawaybill->result[0]->Data->Signature).'</span></td>
                                        ...
                                        <address>
                                            ...
                                            <table style="width:300px;font-size: 11px !important;">
                                                <tr>
                                                    ...
                                                    <td align="right"><b>[</b><b '.(($datawaybill->result[0]->Payment->Name == 'Cash')?'class="text-success"':'').'>'.$datawaybill->result[0]->Payment->Name.'</b><b>]</b></td>
                                                </tr>
                                            </table>
                                            <table style="width:300px;font-size: 9px !important;">
                                                    <tr>
