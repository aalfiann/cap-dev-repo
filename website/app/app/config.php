<?php 
            ...
            $config['basepath'] = 'http://localhost:1337/cap-dev-repo-new/website/app/app'; //Your folder website
            $config['homepath'] = 'http://localhost:1337/cap-dev-repo-new/website/app/app'; //Your folder frontend website
