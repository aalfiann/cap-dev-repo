        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><?php echo Core::lang('report').' '.Core::lang('agent').' '.Core::lang('transaction')?></h3>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive m-t-40">
                                    <a href="modul-agent-transaction.php" class="btn btn-inverse"><i class="mdi mdi-plus"></i> <?php echo Core::lang('add').' '.Core::lang('transaction')?></a>
                                    <table id="datamain" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo Core::lang('agent_setting_company')?></th>
        ...
        function loadData(idtable,page="1",itemperpage="10",firstdate="",lastdate="",search=""){
            $(function() {
                ...
                var table = $(idtable).DataTable({
                    ajax: {
                        type: "GET",
                        url: "<?php echo Core::getInstance()->api.'/cargoagent/transaction/data/search/'.$datalogin['username'].'/'.$datalogin['token'].'/"+page+"/"+itemperpage+"/?firstdate="+firstdate+"&lastdate="+lastdate+"&query="+encodeURIComponent(search)+"'?>",
                        cache: false,
                    ...
                    columns: [
                        ...
                        { "render": function(data,type,row,meta) {
                            return '<a href="modul-inquiry-agent-waybill.php?no='+row.Waybill+'&ref=modul-report-agent-transaction.php&fd='+firstdate+'&ld='+lastdate+'&s='+search+'">'+row.Waybill+'</a>';
                            }
                        },
                        { "render": function(data,type,row,meta) { /* render event defines the markup of the cell text */ 
                                            ...
                                            <div class="modal-content">\
                                                ...
                                                <form class="form-horizontal form-material" id="data'+row.Waybill+'" action="<?php echo $_SERVER['PHP_SELF']?>">\
                                                    <div class="modal-body">\
                                                        <div class="col-sm-12">\
                                                            <a href="print-agent-waybill.php?no='+row.Waybill+'&ref=modul-report-agent-transaction.php&fd='+firstdate+'&ld='+lastdate+'&s='+search+'" class="btn btn-primary"><?php echo Core::lang('print')?></a>\
                                                            <a href="modul-agent-pod.php?no='+row.Waybill+'&ref=modul-report-agent-transaction.php&fd='+firstdate+'&ld='+lastdate+'&s='+search+'" class="btn btn-success"><?php echo Core::lang('pod')?></a>\
                                                            <a href="modul-agent-void.php?no='+row.Waybill+'&ref=modul-report-agent-transaction.php&fd='+firstdate+'&ld='+lastdate+'&s='+search+'" class="btn btn-danger"><?php echo Core::lang('void')?></a>\
                                                        </div>\
                                                    </div>\
                        ...
                        { "render": function(data,type,row,meta) { /* render event defines the markup of the cell text */
                                return row.Company_name.toUpperCase();
                            } 
                        },
                        { data: "Status" },
                        { data: "Created_at" },
