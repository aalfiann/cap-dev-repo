...
$refpage = (empty($_GET['ref'])?Core::lang('info').' '.Core::lang('waybill'):'<a href="'.$_GET['ref'].$refdate.'"><i class="mdi mdi-arrow-left"></i> '.Core::lang('go_back').'</a>');?>
<!DOCTYPE html>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo Core::lang('inquiry').' '.Core::lang('waybill')?></li>
                    </ol>
                </div>
                <div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">:</td>
                                                    <td align="right"><span id="costhandling"></span></td>
                                                </tr>
                                            </table>
                                        </div>
    ...
    <script>
        function getWaybill(waybill){
            $(function(){
                clearData();
                $.ajax({
                    url: Crypto.decode("<?php echo base64_encode(Core::getInstance()->api.'/cargoagent/transaction/data/trace/waybill/'.$datalogin['username'].'/'.$datalogin['token'].'/?no=')?>")+encodeURIComponent(waybill)+"&_="+randomText(2),
                    dataType: "json",
                    type: "GET",
                    success: function(data) {
                        if (data.status == "success"){
                            ...
                            //origin
                            $('#branchid').html(data.result[0].Company.Name);
                            $('#branchname').html(ucwords(data.result[0].Company.Origin));
                            $('#branchphone').html(data.result[0].Company.Phone);
                            $('#branchfax').html(data.result[0].Company.Fax);
                            $('#branchemail').html(data.result[0].Company.Email.toLowerCase());
                            $('#branchaddress').html(data.result[0].Company.Address);
