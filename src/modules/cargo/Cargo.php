<?php
namespace modules\cargo;                       //Make sure namespace is same structure with parent directory
...
use PDO;                                            //To connect with database
     ...
     * @license    https://github.com/aalfiann/reSlim-modules-cargo/blob/master/LICENSE.md  MIT License
     */
    class Cargo {
            ...
            if (Auth::validToken($this->db,$this->token,$this->username)){
				...
				if ($role == 1){
					try {
						...
						$sql = file_get_contents(dirname(__FILE__).'/cargo.sql');
