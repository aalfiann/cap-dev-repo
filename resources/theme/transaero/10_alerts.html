		...
		<div class="container">
			<div class="row">
				...
				<!-- === ALERTS === -->
					...
					<div class="bs-example-alert">
					
						<h3 class="bs-example-title">Examples</h3>
					...
					<div class="bs-example-alert">
						...
						<h3 class="bs-example-title">Dismissable alerts</h3>
					...
					<div class="bs-example-alert">
						...
						<h3 class="bs-example-title">Links in alerts</h3>
