		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					...
					<h3 class="bs-example-title">Lists</h3>
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
					...
					<h3 class="bs-example-title">Headings</h3>
					...
					<div class="bs-example">
						...
						<table class="table">
								<tbody>
								<tr>
									<td class="first-top"><h1>h1.Bootstrap heading</h1></td>
									<td class="type-info first-top">bold 36px</td>
								</tr>
								<tr>
					...
					<h3 class="bs-example-title">Emphasis classes</h3>
					...
					<h3 class="bs-example-title">Blockquotes</h3>
