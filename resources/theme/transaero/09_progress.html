		...
		<div class="container">
			<div class="row">
				...
				<!-- === PROGRESS BARS === -->
					...
					<div class="bs-example-progress">
					
						<h3 class="bs-example-title">Basic</h3>
					...
					<div class="bs-example-progress">
						...
						<h3 class="bs-example-title">Contextual alternatives</h3>
					...
					<div class="bs-example-progress">
						...
						<h3 class="bs-example-title">Striped</h3>
					...
					<div class="bs-example-progress">
						...
						<h3 class="bs-example-title">Animated</h3>
					...
					<div class="bs-example-progress">
						...
						<h3 class="bs-example-title">Stacked</h3>
