				...
				<div class="collapse navbar-collapse main-menu main-menu-1" id="main-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<a href="03_services.html">Service 1</a>
								</li>
								<li>
									<a href="04_services.html">Service 2</a>
								</li>
								<li>
									<a href="05_service_detail.html">Service Details</a>
								</li>
							</ul>
						</li>
						<li class="main-menu-separator"></li>
						...
						<li class="active dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<a href="07_typography.html">Typography</a>
								</li>
								<li class="active">
									<a href="08_buttons.html">Buttons</a>
								</li>
								<li>
									<a href="09_progress.html">Progress Bars</a>
								</li>
								<li>
									<a href="10_alerts.html">Alerts</a>
								</li>
							</ul>
						</li> 
						<li class="main-menu-separator"></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<a href="11_blog.html">Blog items</a>
								</li>
								<li>
									<a href="12_blog_detail.html">Single Post</a>
								</li>
							</ul>
						</li> 
						<li class="main-menu-separator"></li>
						<!-- === top menu item === -->
						<li >
							<a class="latest" href="13_contacts.html">Contacts</a>
						</li>
					</ul>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
					...
					<h3 class="bs-example-title">Buttons Options</h3>
					...
					<h3 class="bs-example-title">Buttons Sizes</h3>
					...
					<div class="bs-example">
						...
						<div class="btns-col btns-col-2">
							...
							<a href="#">
								<div class="my-btn my-btn-primary my-btn-sm">
									<div class="my-btn-bg-top"></div>
									<div class="my-btn-bg-bottom"></div>
									<div class="my-btn-text">
										BUTTON
							...
							<a href="#">
								<div class="my-btn my-btn-primary my-btn-xs">
									<div class="my-btn-bg-top"></div>
									<div class="my-btn-bg-bottom"></div>
									<div class="my-btn-text">
										BUTTON
					...
					<h3 class="bs-example-title">Disabled State</h3>
					
					<div class="bs-example">

						<a href="#" class="btn btn-primary btn-lg disabled">PRIMARY BUTTON</a>
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
					...
					<h3 class="bs-example-title">Tables - basic example - Optionl classes ( Striped - Bordered )</h3>
					...
					<h3 class="bs-example-title">Pagination - disabled and active states</h3>
